...
print('=======')
print('Saving jac info...')
# GET TOTAL JAC INFO, SCALED AND UNSCALED
with open('unscaled_total_jac_info.pickle', 'wb') as file:
    pickle.dump(p.compute_totals(driver_scaling=False), file, protocol=pickle.HIGHEST_PROTOCOL)
with open('scaled_total_jac_info.pickle', 'wb') as file:
    pickle.dump(p.compute_totals(driver_scaling=True), file, protocol=pickle.HIGHEST_PROTOCOL)
print('Jac info archive complete.')

print('=======')
print('Simulating trajectory...')

print(p.get_val('traj.phase0.timeseries.states:range', units='NM')[-1])
