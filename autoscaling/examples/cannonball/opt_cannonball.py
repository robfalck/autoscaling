...
def main():
    ...
    p.run_driver()
    print('Driver was run.')

    # # Save total jacobian info
    # print('Saving total jac info...')
    # with open('cannonball_unsc_tji.pickle', 'wb') as file:
    #     pickle.dump(p.compute_totals(driver_scaling=False), file, protocol=pickle.HIGHEST_PROTOCOL)
    # with open('cannonball_sc_tji.pickle', 'wb') as file:
    #     pickle.dump(p.compute_totals(driver_scaling=True), file, protocol=pickle.HIGHEST_PROTOCOL)
    # print('Saved.')
    #
    # print('Simulating traj...')
    ...
    #
    # plt.savefig('cannonball_opt.png')
    # print('Plotted.')
